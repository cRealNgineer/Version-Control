...
namespace ExcelExport
{
    public partial class Form1 : Form
    {
        ...
        private void CreateExcel() //hierarchikusan építjük fel
        {
            try //más alkalmazásra hivatkozunk, ami sok hibához vezethet
            {
                ...
                xlApp.Visible = true; //enélkül nem jelenik meg az excel!!
        ...
        private void CreateTable()
        {
            ...
            foreach (Flat item in Flats) //object feltöltése
            {
